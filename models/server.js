...
class Server {
    ...
    constructor() {
        ...
        this.paths = {
            ...
            franjasHorarias: '/api/franjas-horarias',
            equipos: '/api/equipos',
            retos: '/api/retos',
            ...
            solicitudesDeporte: '/api/solicitudes-deporte',
    ...
    routes() {
        ...
        this.app.use(this.paths.franjasHorarias, require('../routes/franjas-horarias'));
        ...
        this.app.use(this.paths.solicitudesDeporte, require('../routes/sport-requests'));
